  ...
  return (
    <Box>
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="59" height="51" className='m-auto'>
            <g fill="none" fillRule="evenodd">
                ...
                <path stroke="#757A97" d="M.5 47V5.03C.5 2.53 2.5.5 4.972.5h12.863c.788 0 1.708.687 4.614 3.141 2.462 2.08 3.568 2.905 3.969 2.905h27.61c2.471 0 4.472 2.03 4.472 4.531V47a3.5 3.5 0 0 1-3.5 3.5H4A3.5 3.5 0 0 1 .5 47z"></path>
                <path stroke="#757A97" d="M4 14.5A3.5 3.5 0 0 0 .5 18v29A3.5 3.5 0 0 0 4 50.5h51a3.5 3.5 0 0 0 3.5-3.5V18a3.5 3.5 0 0 0-3.5-3.5H4z"></path>
            </g>
        </svg>
      </Box> :
        <Box
