  ...
  const deals = [
    {
      _id: "1",
      picture:
        "https://themehut.co/html/geair/assets/img/images/offer_img01.jpg",
  ...
  return (
    <Box>
      <Container sx={{ py: "30px", backgroundColor: "#FBF9F2" }}>
        ...
        <Grid
          container
          maxWidth={{ sm: "100%", md: "80%", lg: "100%" }}
          marginX={"auto"}
        >
          <Grid item lg={6} xs={12} height="100%" sx={{ p: 0 }}>
            {deals.slice(0, 1).map((deal) => (
              <OfferDealCard deal={deal} key={deal._id}></OfferDealCard>
            ))}
          </Grid>
          <Grid item lg={6} xs={12} sx={{ width: "100%", marginX: "auto" }}>
            <Grid
              container
              lg:spacing={2}
              marginX={"auto"}
