    ...
    <footer>
        ...
        <Container>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              ...
              <Typography variant="h5" color={"#FFA903"} fontWeight={600}>
                +1 246 333 - 0079
              </Typography>
              <Typography variant="p" color={"#FFA903"}>
                easyBus@company.com
              </Typography>
      ...
      >
        <Container fontWeight={600}>
          <Grid container>
            <Grid item md={6}>
              <Typography color={"#ffffff"} display={"flex"}>
                Copyright © 2022. All Rights Reserved By
                <Typography component="span" color={"#FFA903"} marginLeft={1}>
                  EasyBus
                </Typography>
              </Typography>
            </Grid>
